if gameFlag[1] == 0 then															--If the Flag has not been set
	addHotZone(17*32,17*32,32,32,"story/convo")			--Activate the Conversation
end
addHotZone(mapWidth-8,384+64,8,96,"warps/to_map2")			--Path to woods

createEnemy(math.random(1,5), 30*32, 20*32, "", true)

addPushable(1, 13*32, 16*32, 14, true, "Barrel", "switches/barrel")

addPushable(2, 26*32, 13*32+.01, 80, false, "Door Closed 1", "warps/door_inn_in")
addPushable(3, 8*32, 16*32+.01, 80, false, "Door Closed 1", "warps/door_shed_in")
